...
* `backtick` is replaced with an empty string in bash ([#8](https://github.com/iDNA420/morphe-patches/issues/8)) ([b4da71b](https://github.com/iDNA420/morphe-patches/commit/b4da71b9bd773fd4ef940dc5c55fb6d3c19a8c95))
* `backtick` is replaced with an empty string in bash ([#9](https://github.com/iDNA420/morphe-patches/issues/9)) ([7f20f37](https://github.com/iDNA420/morphe-patches/commit/7f20f377a0a63046d615e664274b3fa9a74cf597))
* Add patch exception message for users who ignore the Manager update prompt ([87beb32](https://github.com/iDNA420/morphe-patches/commit/87beb32f10b05fd960e86cf393bbd14bba9460b5))
* Add Reddit patch exception message for users who ignore the Manager update prompt ([875f10a](https://github.com/iDNA420/morphe-patches/commit/875f10ab1bc502a73e271c407138511e37b90fba))
* Add YouTube patch exception message for users who ignore the Manager update prompt ([296e137](https://github.com/iDNA420/morphe-patches/commit/296e137e63f79493fedea773c1d415cc1da94064))
* **AddResources:** Change resource system to per app, remove per patch resource system that is problematic with Crowdin ([#12](https://github.com/iDNA420/morphe-patches/issues/12)) ([2a652d5](https://github.com/iDNA420/morphe-patches/commit/2a652d521a4b429246ad0e3ca8cf45256266fc0a))
* **Change package name:** DYNAMIC_RECEIVER_NOT_EXPORTED_PERMISSION is not updated correctly ([#1091](https://github.com/iDNA420/morphe-patches/issues/1091)) ([39c5b47](https://github.com/iDNA420/morphe-patches/commit/39c5b47cbd41163bac6fff1a397e186a8e9c567a))
* Change recommended version to 20.37.48 ([898127a](https://github.com/iDNA420/morphe-patches/commit/898127a7a7d8fc9d07da75c66cf864afb12b6f11))
* Change to patcher 1.3.1 ([02b09cf](https://github.com/iDNA420/morphe-patches/commit/02b09cfa7aebe4a4cf954aa9490fcbf06884dfce))
* Change to patcher 1.3.2 ([b8e63dc](https://github.com/iDNA420/morphe-patches/commit/b8e63dc7f18fc496a1159472a12f2ece7f76b273))
* Changing default enum setting type setting does not always always clear preference data ([101fe42](https://github.com/iDNA420/morphe-patches/commit/101fe423de30ac4936aa9c34df6b5165b291480e))
* Create pre-release build for testing ([b3a2318](https://github.com/iDNA420/morphe-patches/commit/b3a2318d38bf2c652c3f6ee22d872a8bb3aec3a8))
* **Custom branding:** Default to user‑provided icon and name when provided ([eef8798](https://github.com/iDNA420/morphe-patches/commit/eef8798602ebf805eb3cff08e010025a0a8e93ab))
* **Custom branding:** Do not override base app name for root installation ([8eb6d48](https://github.com/iDNA420/morphe-patches/commit/8eb6d483a53e99eaa5aece259f0d5a27d2ef5053))
* **Custom branding:** Resolve background playback crash with custom branded root installation ([3039650](https://github.com/iDNA420/morphe-patches/commit/3039650460fdd2731b9ac1622127aa04a2b8a322))
* **Custom branding:** Resolve startup crash if custom branding is excluded in expert mode ([3f2d733](https://github.com/iDNA420/morphe-patches/commit/3f2d7338f587ef8a4ff8331621d6e68dd160d746))
* **Custom branding:** Safely clone bitmaps to prevent native recycled crash in Glide ([#732](https://github.com/iDNA420/morphe-patches/issues/732)) ([f5ffa47](https://github.com/iDNA420/morphe-patches/commit/f5ffa4735097f4d9aaf33c55d469fdf20fcd3d83))
* **Custom branding:** Show user provided custom icon everywhere ([c0433ab](https://github.com/iDNA420/morphe-patches/commit/c0433abbd8be4797c085d6637aa4ebe8ae20f9a6))
* Disable 'open with' link verification that prevents opening YouTube/Music/Reddit web links on some devices ([b9dbfc1](https://github.com/iDNA420/morphe-patches/commit/b9dbfc1e05df0f2268b11caef2f3391dc3d8797d))
* Fix publish? ([acfdef2](https://github.com/iDNA420/morphe-patches/commit/acfdef222c07fe09da47c36616ed1afd19d857f0))
* **GmsCore support:** Change recommended MicroG to MicroG-RE ([9337da4](https://github.com/iDNA420/morphe-patches/commit/9337da40205ba977679dc1a7fa94050d3b4b6fc9))
* **GmsCore support:** Remove vendor id patch option ([7dd0eec](https://github.com/iDNA420/morphe-patches/commit/7dd0eec316689212d491d38a22d556a59def0d8e))
* Move all classes to morphe namespace ([bcd61e7](https://github.com/iDNA420/morphe-patches/commit/bcd61e7f96dbe17b63548bf293c03f71d2aaab60))
* Notification icon entries key mismatch ([#1040](https://github.com/iDNA420/morphe-patches/issues/1040)) ([01ef1ea](https://github.com/iDNA420/morphe-patches/commit/01ef1ea731196325a00de060d6f34f51644a94c5))
* **Override certificate pinning:** Handle element missing from network config ([#574](https://github.com/iDNA420/morphe-patches/issues/574)) ([7b4d015](https://github.com/iDNA420/morphe-patches/commit/7b4d015e4fb37163127257a23de7757c5d2a1f9d))
* **Reddit - Hide sidebar components:** Update patch to work with `2026.12.0` ([bdcde63](https://github.com/iDNA420/morphe-patches/commit/bdcde634e457912e61bce21192fd6e8d8bad3ea2))
* **Reddit - Remove subreddit dialog:** Does not work with experimental app targets ([#1130](https://github.com/iDNA420/morphe-patches/issues/1130)) ([2560192](https://github.com/iDNA420/morphe-patches/commit/2560192985c53b63858e78311057d30d5a2887f7))
* **Reddit:** App side bar may not be shown ([7df05c2](https://github.com/iDNA420/morphe-patches/commit/7df05c2637fbcc370d7f10950ca8f586134e09e1))
* **Reddit:** Change recommended app target to `2026.03.0` ([7a5cda5](https://github.com/iDNA420/morphe-patches/commit/7a5cda571d4ec5e6324cc2905d0c8dec3b0c8f52))
* **Reddit:** Fix Recently Visited Shelf patch not being usable ([#316](https://github.com/iDNA420/morphe-patches/issues/316)) ([49bab2b](https://github.com/iDNA420/morphe-patches/commit/49bab2becde7f1adf593266b88abba0b876925ba))
* **Reddit:** Handle navigation bar buttons hidden behind feature flags ([#328](https://github.com/iDNA420/morphe-patches/issues/328)) ([2b8c337](https://github.com/iDNA420/morphe-patches/commit/2b8c33702293acfbd859cdfbdf1342e5f9e96bc2))
* Remove DSL from fingerprints ([#6](https://github.com/iDNA420/morphe-patches/issues/6)) ([bd385bf](https://github.com/iDNA420/morphe-patches/commit/bd385bf8bca2e8cc5efe8c124a14d320f80ef75d))
* Remove installation nag screen that prevent sharing with close friends, but also will never stop counterfeit sites ([c8dc331](https://github.com/iDNA420/morphe-patches/commit/c8dc33165d52152f3d531200bd79f052638adb35))
* Remove PAT from GitHub actions ([7fc9408](https://github.com/iDNA420/morphe-patches/commit/7fc9408e4383509e99d179b0194b8064942f181a))
* Remove restrictions on AGP due to the use of hardcoded registers in LithoFilterPatch ([#41](https://github.com/iDNA420/morphe-patches/issues/41)) ([223ed8f](https://github.com/iDNA420/morphe-patches/commit/223ed8f78561d8cb046d371baed9646b4e8138f3))
* Rename `bundleBundles` to `generatePatchesList` ([6a57b50](https://github.com/iDNA420/morphe-patches/commit/6a57b508bac801bebd5abf1136539147f1f24c86))
* Resolve navigation bar patch not working ([9e21cfd](https://github.com/iDNA420/morphe-patches/commit/9e21cfd1c55b880e01f3ffd9296dcdab36e2282b))
* Resolve patching error with older versions of Android ([84c74ae](https://github.com/iDNA420/morphe-patches/commit/84c74ae7a9678ab7c89a660d0dd38d78db506e8f))
* Resolve ssl connection timeout in ci (test) ([9e94551](https://github.com/iDNA420/morphe-patches/commit/9e94551f78a87f4eb6f60aabcec98fe7874f2158))
* Restore code ([9b45623](https://github.com/iDNA420/morphe-patches/commit/9b45623c4596034a353bcfbe4e927ec012564d7e))
* Revert Android Studio automatic changes ([549e50c](https://github.com/iDNA420/morphe-patches/commit/549e50cc1ebc85ae9c2457cd7b1d2665832433b5))
* **Sanitize sharing links:** Sanitize new `is` sharing parameter ([18b1fdb](https://github.com/iDNA420/morphe-patches/commit/18b1fdb80c76a2fc4510fc53775437f5cbfc8bd9))
* **Settings:** Bypass click debounce for toggleable preferences ([#1175](https://github.com/iDNA420/morphe-patches/issues/1175)) ([b7f453f](https://github.com/iDNA420/morphe-patches/commit/b7f453fb1bdcc3c962a41d07ef840b352249d1db))
* **Settings:** Improve back gesture, prevent double-clicks, and fix theme update ([#920](https://github.com/iDNA420/morphe-patches/issues/920)) ([a2e86d2](https://github.com/iDNA420/morphe-patches/commit/a2e86d28171e13179d672766929f9c7e9afe3003))
* **Settings:** Prevent duplicate dialogs on rapid preference clicks ([#900](https://github.com/iDNA420/morphe-patches/issues/900)) ([478d97a](https://github.com/iDNA420/morphe-patches/commit/478d97aa0856b6ebd7cbf41d5c10850295ba2fb8))
* **Spoof video streams:** Change default client to Android VR ([cafec9c](https://github.com/iDNA420/morphe-patches/commit/cafec9c61ec65740358777121172896ed7efdf18))
* **Spoof video streams:** Change default client to VR 1.47.48 ([#116](https://github.com/iDNA420/morphe-patches/issues/116)) ([2bc5775](https://github.com/iDNA420/morphe-patches/commit/2bc577554f54fd2ecfcd682b83844511461effe4))
* **Spoof video streams:** Change patch to default excluded for root ([546580d](https://github.com/iDNA420/morphe-patches/commit/546580d53c87329c53ed69809b1e1301998e9fb9))
* **Spoof video streams:** Disable client flag that breaks playback with experimental app targets ([8cace8b](https://github.com/iDNA420/morphe-patches/commit/8cace8b442d32c07b2fcd4da3b596497608e626c))
* **Spoof video streams:** Expose patch to root (mount) install since the patch now works again with rooted devices ([0363d75](https://github.com/iDNA420/morphe-patches/commit/0363d75d19ac6a6ec02319562f8f687db5027d6f))
* **Spoof video streams:** Handle Number.toLocaleString() for webview versions that have issues ([#919](https://github.com/iDNA420/morphe-patches/issues/919)) ([20b6801](https://github.com/iDNA420/morphe-patches/commit/20b68015857502f447d85e888051dd371128676f))
* **Spoof video streams:** Restore missing file during commit conflict resolution ([b5e6fb3](https://github.com/iDNA420/morphe-patches/commit/b5e6fb330ea2ff4976836b410aadb97e6c9de559))
* **Spoof video streams:** Show TV client deobfuscate toast only if debugging is enabled ([b9b685c](https://github.com/iDNA420/morphe-patches/commit/b9b685c6aac6aac59aab04f6b5b28252bc424683))
* **Spoof video streams:** Spoofing does not work if the default client is not `TV` ([#373](https://github.com/iDNA420/morphe-patches/issues/373)) ([8a40c96](https://github.com/iDNA420/morphe-patches/commit/8a40c96bdcb13d20f2f2c2055735f9678fc92bce))
* **Spoof video streams:** Using the TV client can cause a V8 runtime memory leak ([#564](https://github.com/iDNA420/morphe-patches/issues/564)) ([59a4061](https://github.com/iDNA420/morphe-patches/commit/59a4061b28b4be38c4a836a22aa2af429edad5e2))
* Update Crowdin translations ([b652e67](https://github.com/iDNA420/morphe-patches/commit/b652e6731eebe67f1c20cb0e0d83ace9a94167cb))
* Use 'notification' language instead of 'toast' ([82d1b9c](https://github.com/iDNA420/morphe-patches/commit/82d1b9cf9d85557482e4d08093944e8e7f1a68fb))
* Use jsdelivr for patch bundle hosting ([3b8b3f0](https://github.com/iDNA420/morphe-patches/commit/3b8b3f087859ebb17b9beffd4c2ce3fdca627a4a))
* Use more informative patch error if the same APK is patched twice ([52e8b1f](https://github.com/iDNA420/morphe-patches/commit/52e8b1f78522a1d5e23a7956cb3d52ad450d8c9c))
* **YouTube - Alternative thumbnails:** Use correct DeArrow parameter casing ([a35a012](https://github.com/iDNA420/morphe-patches/commit/a35a01243b2bfa674d5711f3db0a0f675f4ebc6f))
* **YouTube - Ambient mode:** Resolve "Bypass Ambient mode restrictions" not bypassing ([#392](https://github.com/iDNA420/morphe-patches/issues/392)) ([f5b71b2](https://github.com/iDNA420/morphe-patches/commit/f5b71b2582f3919ee02cc58b40ce0a1a49c50b91))
* **YouTube - Auto captions:** Cannot disable auto captions with 20.21 app target ([#145](https://github.com/iDNA420/morphe-patches/issues/145)) ([dc43944](https://github.com/iDNA420/morphe-patches/commit/dc43944adbcef5aa4754ca3d1fecd07a502277f3))
* **YouTube - Captions:** Captions are not available in Shorts when `Auto captions visibility` is `Never show` ([#591](https://github.com/iDNA420/morphe-patches/issues/591)) ([e386664](https://github.com/iDNA420/morphe-patches/commit/e3866641aa544598174e5a65ef22654410b3e5c5))
* **YouTube - Captions:** Captions disabled due to incorrect hooking ([#908](https://github.com/iDNA420/morphe-patches/issues/908)) ([a03f245](https://github.com/iDNA420/morphe-patches/commit/a03f24563a567a6ebd7bf55e1844ef6f2c06529c))
* **YouTube - Captions:** Sometimes auto captions are not disabled in Shorts ([#872](https://github.com/iDNA420/morphe-patches/issues/872)) ([8efba43](https://github.com/iDNA420/morphe-patches/commit/8efba43064c21652f6221954fddca436cb89e011))
* **YouTube - Change form factor:** Explore button sometimes shows in Automotive layout ([#820](https://github.com/iDNA420/morphe-patches/issues/820)) ([2980489](https://github.com/iDNA420/morphe-patches/commit/2980489f3c0e6c95d9fd71c8b094ae9423da2a1b))
* **YouTube - Change miniplayer color:** Fix patching experimental app target changes ([1c6c61f](https://github.com/iDNA420/morphe-patches/commit/1c6c61f82e0fbbf4e8609b84c26b005ed3c50df2))
* **YouTube - Change start page:** Remove explore and trending start pages that YouTube no longer supports ([f165f0c](https://github.com/iDNA420/morphe-patches/commit/f165f0c2a44f37ab3e2f036644eb5057f0a89bd4))
* **YouTube - Disable Shorts resuming on startup:** Resolve patch not working on experimental versions ([#848](https://github.com/iDNA420/morphe-patches/issues/848)) ([0b8e77a](https://github.com/iDNA420/morphe-patches/commit/0b8e77ac56ffc637bf2186e98189857362a14438))
* **YouTube - Disable video codecs:** Improve setting summary if the spoof video client does not support forcing AVC ([0238d14](https://github.com/iDNA420/morphe-patches/commit/0238d14df83198f41c9cbddd4aa4933ba995581d))
* **YouTube - Double tap to seek:** Playback setting menu does not open when patched with CLI pre-release ([ba1784d](https://github.com/iDNA420/morphe-patches/commit/ba1784df70cb4cbfe786e991e75bb1d8f97a6dbf))
* **YouTube - Downloads:** Change Seal to hidden preset and add Seal pre-release ([#371](https://github.com/iDNA420/morphe-patches/issues/371)) ([0406aee](https://github.com/iDNA420/morphe-patches/commit/0406aee91b0bf14430ce33dc39d3a06b4434ce0c))
* **YouTube - Exit fullscreen mode:** Handle exiting fullscreen on the first video opened ([7aedf33](https://github.com/iDNA420/morphe-patches/commit/7aedf33f910da53f5edeada0ac28c27c6bf4d34b))
* **YouTube - Hide ads:** `Hide video ads` does not hide Shorts ads ([#260](https://github.com/iDNA420/morphe-patches/issues/260)) ([9078d92](https://github.com/iDNA420/morphe-patches/commit/9078d92c444d1d6abe095a3a694a518e7fb078e9))
* **YouTube - Hide ads:** Empty space is left when ads are hidden on tablets ([#377](https://github.com/iDNA420/morphe-patches/issues/377)) ([da12960](https://github.com/iDNA420/morphe-patches/commit/da12960ceb4d93490b8d41f0ea616d686eb609eb))
* **YouTube - Hide ads:** Fix "Hide YouTube Premium promotions" hiding YouTube Doodles ([#370](https://github.com/iDNA420/morphe-patches/issues/370)) ([61860b7](https://github.com/iDNA420/morphe-patches/commit/61860b7784a2ad4946fd71fb211ae2d2c56d4d1b))
* **YouTube - Hide ads:** Fullscreen ads sometimes show with older versions of YouTube ([4a58cb9](https://github.com/iDNA420/morphe-patches/commit/4a58cb9dafa51429cc46ab2b2c8098d7eb622e50))
* **YouTube - Hide ads:** Hide all promotion banner ads ([#987](https://github.com/iDNA420/morphe-patches/issues/987)) ([9096bcd](https://github.com/iDNA420/morphe-patches/commit/9096bcd4cea53c57a8cb336421d53302ea8cd444))
* **YouTube - Hide ads:** Hide new type of ad ([7e6b1e4](https://github.com/iDNA420/morphe-patches/commit/7e6b1e400fd93c1080ab82a6b12844159ef3ad89))
* **YouTube - Hide ads:** Hide new type of ad ([#594](https://github.com/iDNA420/morphe-patches/issues/594)) ([87c2d24](https://github.com/iDNA420/morphe-patches/commit/87c2d24725e4ceccb9a000c95e1b7487ff9fc6b6))
* **YouTube - Hide ads:** Hide new type of general ad, movie ad and web search result ([#92](https://github.com/iDNA420/morphe-patches/issues/92)) ([fe51d8c](https://github.com/iDNA420/morphe-patches/commit/fe51d8caa2de13136ea3c4775147b0b572f60bda))
* **YouTube - Hide ads:** Hide new type of player ad ([#187](https://github.com/iDNA420/morphe-patches/issues/187)) ([4702043](https://github.com/iDNA420/morphe-patches/commit/4702043ea35fb3b1439ad30406b41179d019f2a1))
* **YouTube - Hide ads:** Hide new type of product sticker ([#1484](https://github.com/iDNA420/morphe-patches/issues/1484)) ([aa3637d](https://github.com/iDNA420/morphe-patches/commit/aa3637ddb2470ad5147ebb1ccad10311d366571a)), closes [#1481](https://github.com/iDNA420/morphe-patches/issues/1481)
* **YouTube - Hide ads:** Resolve "Hide YouTube Premium promotions" affecting YouTube Doodles ([#1135](https://github.com/iDNA420/morphe-patches/issues/1135)) ([881f61b](https://github.com/iDNA420/morphe-patches/commit/881f61ba200083e3ee35b7e0cf2675ee1f7678d6))
* **YouTube - Hide ads:** Support `Hide fullscreen ads` on Android 13+ devices ([#17](https://github.com/iDNA420/morphe-patches/issues/17)) ([f147194](https://github.com/iDNA420/morphe-patches/commit/f147194f9c9a0dc552e0624a6db45d6d5e9714c3))
* **YouTube - Hide ads:** YouTube Doodles are unclickable when Hide ads is turned on ([f533641](https://github.com/iDNA420/morphe-patches/commit/f533641d4a806d0a7066dc1042bcf4019f915354))
* **YouTube - Hide ads:** YouTube Doodles are unclickable when Hide ads is turned on ([8642921](https://github.com/iDNA420/morphe-patches/commit/8642921c2b3d6596d709aadc7aa89ed612746814))
* **YouTube - Hide end screen cards:** Resolve patching `20.31.42` ([3033432](https://github.com/iDNA420/morphe-patches/commit/3033432644fc986930f4eec51d4fc233f6389c23))
* **YouTube - Hide end screen suggested video:** Add user dialogs to minimize user confusion ([#637](https://github.com/iDNA420/morphe-patches/issues/637)) ([6d4af87](https://github.com/iDNA420/morphe-patches/commit/6d4af87dd6880d6114c24815109da4149df3c3b8))
* **YouTube - Hide layout components:** "Hide info panel" does not work in search results ([#1229](https://github.com/iDNA420/morphe-patches/issues/1229)) ([a846ce3](https://github.com/iDNA420/morphe-patches/commit/a846ce3096484aed65b2a3f7bf5b1a4a67cb6ecb))
* **YouTube - Hide layout components:** `Hide Featured places` also hide watch history shelf ([#420](https://github.com/iDNA420/morphe-patches/issues/420)) ([fcb6758](https://github.com/iDNA420/morphe-patches/commit/fcb675828b3465e5ea7b88cc659bbad284f6daa1))
* **YouTube - Hide layout components:** `Hide Show more button` leaves empty space ([#422](https://github.com/iDNA420/morphe-patches/issues/422)) ([d44862d](https://github.com/iDNA420/morphe-patches/commit/d44862d81dc8d4b07cfcf1af7109e3dd6feae414))
* **YouTube - Hide layout components:** `Hide subscribed channels bar` leaves empty space ([#404](https://github.com/iDNA420/morphe-patches/issues/404)) ([6b68416](https://github.com/iDNA420/morphe-patches/commit/6b6841626d76c9679b4b9bebfa98ccab9d617fd2))
* **YouTube - Hide layout components:** Do not change system nav bar transparency when disabling status bar transparency ([4ad98fd](https://github.com/iDNA420/morphe-patches/commit/4ad98fddbadf77c0132287978ad59051498a149f))
* **YouTube - Hide layout components:** Fix "Hide ticket shelf" not working when "Hide horizontal shelves" is off ([#124](https://github.com/iDNA420/morphe-patches/issues/124)) ([84eeb0d](https://github.com/iDNA420/morphe-patches/commit/84eeb0d9f949657a7d468d9babfaca37d03b0d78))
* **YouTube - Hide layout components:** Fix certain description components not working ([#143](https://github.com/iDNA420/morphe-patches/issues/143)) ([4efcb4d](https://github.com/iDNA420/morphe-patches/commit/4efcb4d2c0f2085b6dbd0d203ef2979a041d512a))
* **YouTube - Hide layout components:** Fix side effect of Disable translucent status bar ([335ce8d](https://github.com/iDNA420/morphe-patches/commit/335ce8dce5b643769aaf99cddaf16e403ea6baaa))
* **YouTube - Hide layout components:** Hide flyout menu items for experimental app targets ([#1358](https://github.com/iDNA420/morphe-patches/issues/1358)) ([d2c324f](https://github.com/iDNA420/morphe-patches/commit/d2c324f2d25130ac6250539a006b9ccd10d04429))
* **YouTube - Hide layout components:** Hide new type of community post ([#1114](https://github.com/iDNA420/morphe-patches/issues/1114)) ([9fc6aef](https://github.com/iDNA420/morphe-patches/commit/9fc6aefba130629cbeefb5d4bfa1cd798e9ce995))
* **YouTube - Hide layout components:** Hide new type of community post ([#1476](https://github.com/iDNA420/morphe-patches/issues/1476)) ([50085da](https://github.com/iDNA420/morphe-patches/commit/50085dab0ceed84778d40b40150f7a16c5ea18ec))
* **YouTube - Hide layout components:** Hide preview comment dots ([#1208](https://github.com/iDNA420/morphe-patches/issues/1208)) ([8a2b63b](https://github.com/iDNA420/morphe-patches/commit/8a2b63be46400113b4556a5ef73156b44aacde9a))
* **YouTube - Hide layout components:** Replace "Hide AI comments summary" with "Sanitize category bar" ([#731](https://github.com/iDNA420/morphe-patches/issues/731)) ([bb0debf](https://github.com/iDNA420/morphe-patches/commit/bb0debfc6343afd2b723411a15354209a734c691))
* **YouTube - Hide layout components:** Replace "Hide search suggestions" with "Hide You may like section" ([#581](https://github.com/iDNA420/morphe-patches/issues/581)) ([29d891c](https://github.com/iDNA420/morphe-patches/commit/29d891c63c6b5c937420f7e9fb796b530c45847f))
* **YouTube - Hide layout components:** Resolve "Hide comments section in Home feed" not hiding comments ([#473](https://github.com/iDNA420/morphe-patches/issues/473)) ([915849b](https://github.com/iDNA420/morphe-patches/commit/915849b888ff66007af4051cdb307573047285fa))
* **YouTube - Hide layout components:** Resolve "Hide community posts" not working in search results ([#485](https://github.com/iDNA420/morphe-patches/issues/485)) ([9083a16](https://github.com/iDNA420/morphe-patches/commit/9083a16bd3f0098acabebee91e660f15b676d1fb))
* **YouTube - Hide layout components:** Resolve "Hide community posts" not working when selecting a channel from subscribed channels bar in Subscriptions tab ([#816](https://github.com/iDNA420/morphe-patches/issues/816)) ([416d4ea](https://github.com/iDNA420/morphe-patches/commit/416d4ea2b1c7d545d5c9c6ec1af1ce58a8ff5904))
* **YouTube - Hide layout components:** Resolve "Hide Explore the podcast" not working ([#691](https://github.com/iDNA420/morphe-patches/issues/691)) ([fd50458](https://github.com/iDNA420/morphe-patches/commit/fd504587cacaf665816c908b5db124f7a2e7bdd1))
* **YouTube - Hide layout components:** Resolve "Hide How this was made" not working in Shorts description ([#1257](https://github.com/iDNA420/morphe-patches/issues/1257)) ([1a188de](https://github.com/iDNA420/morphe-patches/commit/1a188de4e374ca659f90c0d1b955fe1080974138))
* **YouTube - Hide layout components:** Resolve "Hide subscribed channels bar" leaves empty space in landscape mode ([#421](https://github.com/iDNA420/morphe-patches/issues/421)) ([83230a6](https://github.com/iDNA420/morphe-patches/commit/83230a61bc7b9909af87869456580927047a5aac))
* **YouTube - Hide layout components:** Resolve community posts sometimes showing in the player suggestions ([0d0886a](https://github.com/iDNA420/morphe-patches/commit/0d0886a1d45cb33bb9b43542009b14849fd47849))
* **YouTube - Hide layout components:** Resolve patch failing on `20.21.37` and `20.31.42` ([#971](https://github.com/iDNA420/morphe-patches/issues/971)) ([387df8c](https://github.com/iDNA420/morphe-patches/commit/387df8cc609b26ff2591b3a97e3865996e425db3))
* **YouTube - Hide player flyout menu components:** Cannot hide flyout menu items with `20.21.37` ([#1158](https://github.com/iDNA420/morphe-patches/issues/1158)) ([3374765](https://github.com/iDNA420/morphe-patches/commit/3374765710cd3988e19a2aa15132eedc86f2b5c2))
* **YouTube - Hide player flyout menu components:** Resolve "Hide Captions footer" hiding other components ([#1160](https://github.com/iDNA420/morphe-patches/issues/1160)) ([cf9259a](https://github.com/iDNA420/morphe-patches/commit/cf9259ab50f5cc8aafe8c615ae7cf87215ac0160))
* **YouTube - Hide player flyout menu items:** Do not hide entire flyout menu for eperimental app targets ([7407796](https://github.com/iDNA420/morphe-patches/commit/7407796551978351a74db742715154ca8e96493e))
* **YouTube - Hide player flyout menu items:** Do not hide speed flyout menu if 'Hide loop video' is enabled ([46834e5](https://github.com/iDNA420/morphe-patches/commit/46834e5fdbba474e6aff693caad7ae14b6f0eb65))
* **YouTube - Hide player flyout menu items:** Hide additional menu items with 20.22+ ([f6ea051](https://github.com/iDNA420/morphe-patches/commit/f6ea051b634aa5641f6448331a28f83bb83efbdd))
* **YouTube - Hide player flyout menu items:** Remove hide submenu items for 20.22+ ([8b72e92](https://github.com/iDNA420/morphe-patches/commit/8b72e9265124c1e1c87aaed7e6ae46ba4fef3e9e))
* **YouTube - Hide player overlay buttons:** Do not hide Morphe player buttons if hide fullscreen button is enabled ([96c5789](https://github.com/iDNA420/morphe-patches/commit/96c5789e45ea2f5827db93319d9be7405c8cee19))
* **YouTube - Hide Shorts components:** Action buttons are not hidden in YouTube 20.22+ ([#4](https://github.com/iDNA420/morphe-patches/issues/4)) ([8b9cecb](https://github.com/iDNA420/morphe-patches/commit/8b9cecb1a4299406795df71a55f59dc0b2644f19))
* **YouTube - Hide Shorts components:** Fix "Hide sound metadata label" hiding other components ([#277](https://github.com/iDNA420/morphe-patches/issues/277)) ([b55ebe4](https://github.com/iDNA420/morphe-patches/commit/b55ebe4f0fac71905ce8c02185a174c661627b70))
* **YouTube - Hide Shorts components:** Hide new type of sound metadata label ([35931e6](https://github.com/iDNA420/morphe-patches/commit/35931e6ddf287790c6a405b58e7b7d46c718bb0a))
* **YouTube - Hide Shorts components:** Hide Shorts in search nav button ([#749](https://github.com/iDNA420/morphe-patches/issues/749)) ([4bb1162](https://github.com/iDNA420/morphe-patches/commit/4bb11623be6828e4e0d53afc736678c34400266f))
* **YouTube - Hide Shorts components:** Hide Shorts shelf hides autoplaying videos in the feed ([#788](https://github.com/iDNA420/morphe-patches/issues/788)) ([01328e7](https://github.com/iDNA420/morphe-patches/commit/01328e7f048949384186f0ce6fd4230f81e32702))
* **YouTube - Hide Shorts components:** Resolve "Hide 'Use this sound' button" and "Hide 'Use this template' button" breaking Shorts player ([#830](https://github.com/iDNA420/morphe-patches/issues/830)) ([ffff45a](https://github.com/iDNA420/morphe-patches/commit/ffff45a529f788707464eed85b7cc6c2c7e513fb))
* **YouTube - Hide Shorts components:** Resolve "Hide 'Use this sound' button" and "Hide 'Use this template' button" not working ([#815](https://github.com/iDNA420/morphe-patches/issues/815)) ([9f2a67b](https://github.com/iDNA420/morphe-patches/commit/9f2a67bd38ac2b8fd038197736f8db0483960c7d))
* **YouTube - Hide Shorts components:** Resolve hiding Shorts also hiding channel page headers ([#518](https://github.com/iDNA420/morphe-patches/issues/518)) ([966232b](https://github.com/iDNA420/morphe-patches/commit/966232b6e7bd610b09b2b7ce40ade735115f7748))
* **YouTube - Hide Shorts components:** Resolve hiding Shorts not working ([#610](https://github.com/iDNA420/morphe-patches/issues/610)) ([dbef1c4](https://github.com/iDNA420/morphe-patches/commit/dbef1c419e6b871e5587e9c6f800ff622e962c2c))
* **YouTube - Hide Shorts components:** Resolve Shorts header not being hidden ([#649](https://github.com/iDNA420/morphe-patches/issues/649)) ([84901c2](https://github.com/iDNA420/morphe-patches/commit/84901c261ea0808514cca24c5bd7687389acae5c))
* **YouTube - Hide Shorts components:** Shorts shelves are sometimes not hidden ([#870](https://github.com/iDNA420/morphe-patches/issues/870)) ([301d3b0](https://github.com/iDNA420/morphe-patches/commit/301d3b0528415b56f49979ef4cf7797d034ad308))
* **YouTube - Hide video action buttons:** Some action buttons cannot be hidden in YouTube 20.22+ ([#736](https://github.com/iDNA420/morphe-patches/issues/736)) ([61ebf75](https://github.com/iDNA420/morphe-patches/commit/61ebf754b8e92a072ed9721573fb26cfe468e888))
* **YouTube - Hide video action buttons:** Update hide like and subscribe button glow for 20.22+ ([2a46180](https://github.com/iDNA420/morphe-patches/commit/2a461804de635c5a3df491f51343ac069954e943))
* **YouTube - LithoFilterPatch:** Use an encoded native byte array for buffer searching ([#654](https://github.com/iDNA420/morphe-patches/issues/654)) ([bb5cc01](https://github.com/iDNA420/morphe-patches/commit/bb5cc0198ee87f292795c3b03127a6a82ef72647))
* **YouTube - LithoFilter:** Press the back button twice instead of once to exit the app ([#907](https://github.com/iDNA420/morphe-patches/issues/907)) ([c450c5a](https://github.com/iDNA420/morphe-patches/commit/c450c5abecc416e05b335fa178382501b0e3d7b3))
* **YouTube - Loop video:** `Enable loop video` setting not working in playlist ([#14](https://github.com/iDNA420/morphe-patches/issues/14)) ([53f35e8](https://github.com/iDNA420/morphe-patches/commit/53f35e840c99a5fdfcfd703cb8683bfc586d2d05))
* **YouTube - Loop video:** Fix looping button state ([#22](https://github.com/iDNA420/morphe-patches/issues/22)) ([46380b9](https://github.com/iDNA420/morphe-patches/commit/46380b9982a73a8236b88cba387cab3566e81687))
* **YouTube - Loop video:** Wrong icon applied ([#13](https://github.com/iDNA420/morphe-patches/issues/13)) ([57cb0fc](https://github.com/iDNA420/morphe-patches/commit/57cb0fcd320b2b6a75dc9aec1ea41d6bd3d6c6ae))
* **YouTube - Miniplayer:** Minimal miniplayer has wrong play icon ([2eddce0](https://github.com/iDNA420/morphe-patches/commit/2eddce052761c6e7cd519ef3f57e098ca4044c3e))
* **YouTube - Navigation bar:** Rename "Switch Create with Notifications" to "Swap Create with Notifications" ([#384](https://github.com/iDNA420/morphe-patches/issues/384)) ([6472dee](https://github.com/iDNA420/morphe-patches/commit/6472dee35dae7d3b0ba08dd2b4348b535ce48da7))
* **YouTube - Navigation bar:** Resolve experimental player black bar when "Disable translucent status bar" is enabled ([#464](https://github.com/iDNA420/morphe-patches/issues/464)) ([1a9dd11](https://github.com/iDNA420/morphe-patches/commit/1a9dd1128b13161318157e632e8e4125140081b3))
* **YouTube - Navigation bar:** Use updated activity hook for toolbar settings menu ([fafac89](https://github.com/iDNA420/morphe-patches/commit/fafac89df0680a9fd8fe3dc09983f99c157b8dca))
* **YouTube - Open channel of live avatar:** Add missing resources ([#1463](https://github.com/iDNA420/morphe-patches/issues/1463)) ([0870e3c](https://github.com/iDNA420/morphe-patches/commit/0870e3c3dc8a3ec3bd42af174bb7d63106658d29))
* **YouTube - Open channel of live avatar:** Fixed remaining translations ([#1491](https://github.com/iDNA420/morphe-patches/issues/1491)) ([d3433ab](https://github.com/iDNA420/morphe-patches/commit/d3433ab92a8bad7af00c795de44f943136dd2987))
* **YouTube - Open channel of live avatar:** patch doesn't work for arabic/korean localizations ([ff16083](https://github.com/iDNA420/morphe-patches/commit/ff160839fdcc03e24c9eff3eec4499b58febc26a))
* **YouTube - Open channel of live avatar:** patch doesn't work for vietnamese localization ([#1479](https://github.com/iDNA420/morphe-patches/issues/1479)) ([2a5979e](https://github.com/iDNA420/morphe-patches/commit/2a5979ee3184ea4ca7a045c61363c853e6cbea15))
* **YouTube - Open channel of live avatar:** patch doesn't work in video player ([3f03a18](https://github.com/iDNA420/morphe-patches/commit/3f03a184d9997f844a934b76a05fd6b228d38529))
* **YouTube - Open channel of live avatar:** Patch may not work when app is using non English language ([#1459](https://github.com/iDNA420/morphe-patches/issues/1459)) ([34d55c2](https://github.com/iDNA420/morphe-patches/commit/34d55c27d9f915cc39bed37af5a9a4c1e28a3e0f))
* **YouTube - Open Shorts in regular player:** Back button does not work when viewing Shorts in the regular player ([#1269](https://github.com/iDNA420/morphe-patches/issues/1269)) ([3976592](https://github.com/iDNA420/morphe-patches/commit/3976592a983234e2d9470bfe82496d64aed6ddde))
* **YouTube - Open Shorts in regular player:** Fix back to exit with 20.51 ([d0a9584](https://github.com/iDNA420/morphe-patches/commit/d0a95840abe24482643626c3681bdf35208e65b4))
* **YouTube - Open Shorts in regular player:** Resolve back button sometimes closing the app instead of exiting fullscreen mode ([fba010b](https://github.com/iDNA420/morphe-patches/commit/fba010b8e99dcce3411824df296be5a61f4b87f0))
* **YouTube - Overlay buttons:** Always use thin player overlay buttons with 20.21.37 ([db96e8e](https://github.com/iDNA420/morphe-patches/commit/db96e8e34d7e0c1393562a7f1dfa5fd0fb1f9c5d))
* **YouTube - Override YouTube Music buttons:** Support launching arbitrary third-party music clients ([#1177](https://github.com/iDNA420/morphe-patches/issues/1177)) ([7514bf7](https://github.com/iDNA420/morphe-patches/commit/7514bf7a7e8f0377f7804c420eeaf02106617f2d))
* **YouTube - Playback speed:** 21.15.282 speed button text alignment is wrong ([16104ac](https://github.com/iDNA420/morphe-patches/commit/16104ac969c89cb58ca49d47c04792a0918ba173))
* **YouTube - Playback speed:** Old playback speed menu does not show with experimental app targets ([d90579f](https://github.com/iDNA420/morphe-patches/commit/d90579fd93bea9628f787df34e2bbf3302c23e85))
* **YouTube - Playback speed:** Playback speed menu opens from the feed flyout menu when `Restore old playback speed menu` is off ([#906](https://github.com/iDNA420/morphe-patches/issues/906)) ([3bb93a9](https://github.com/iDNA420/morphe-patches/commit/3bb93a9fd1b838593ed5e3f38314855cade17c3f))
* **YouTube - PlayerOverlayButton:** reset skipFirstCall for next updateRef attempts ([9d12346](https://github.com/iDNA420/morphe-patches/commit/9d12346c17a11fd9c4452ba14ee5e96312b760e8))
* **YouTube - PlayerOverlayButton:** set videoHeading container ref only in upper bar constructor to avoid race condition ([#1478](https://github.com/iDNA420/morphe-patches/issues/1478)) ([93c6300](https://github.com/iDNA420/morphe-patches/commit/93c6300450a5fafbb815a79d112707880109f358))
* **YouTube - PlayerOverlayButton:** Video heading margin not applied when no bottom buttons present ([#1472](https://github.com/iDNA420/morphe-patches/issues/1472)) ([12bee40](https://github.com/iDNA420/morphe-patches/commit/12bee40312e040c7bccd17f9d1af2e56d3214972))
* **YouTube - Remove background playback restrictions:** Add in-app setting to manually turn off the patch ([#1325](https://github.com/iDNA420/morphe-patches/issues/1325)) ([7877952](https://github.com/iDNA420/morphe-patches/commit/7877952d5a29cf19b931227014964ea471e5d870))
* **YouTube - Remove background playback restrictions:** Fix background playback not working with certain offline videos ([bb38f76](https://github.com/iDNA420/morphe-patches/commit/bb38f763f271d14b80166d517a3e840578d1f5b9))
* **YouTube - Remove viewer discretion dialog:** Not working on YouTube 20.14.43+ ([#19](https://github.com/iDNA420/morphe-patches/issues/19)) ([63dbb57](https://github.com/iDNA420/morphe-patches/commit/63dbb57f2b1e0cf14504c2f7e75d3c9c25be8df4))
* **YouTube - Return YouTube Dislike:** Sometimes incorrect dislike counts shown when the dislike button is clicked and then canceled ([850dd66](https://github.com/iDNA420/morphe-patches/commit/850dd66b064b3a24a707883b8934f9c4fe43c71d))
* **YouTube - ReturnYouTubeDislike:** Fix dislikes not showing with 20.31+ ([2b243c4](https://github.com/iDNA420/morphe-patches/commit/2b243c48f1fd4e4b633d9abcf3acf22927ecc08c))
* **YouTube - Save to watch later:** Support saving videos to 'brand' accounts, prevent opening live shorts from live avatar ([#1438](https://github.com/iDNA420/morphe-patches/issues/1438)) ([0b12c81](https://github.com/iDNA420/morphe-patches/commit/0b12c81793aac544f83aa36ee0c19c88cf81cbda))
* **YouTube - Settings:** Icon doesn't change immediately with the theme ([#85](https://github.com/iDNA420/morphe-patches/issues/85)) ([f4800ca](https://github.com/iDNA420/morphe-patches/commit/f4800cabc1552c1987ee12a39a5450934056bc0e))
* **YouTube - Shorts autoplay:** Shorts do not autoplay when using older app targets ([1c6478e](https://github.com/iDNA420/morphe-patches/commit/1c6478e02a6e2a0c795f40608c653ed115292e5e))
* **YouTube - SponsorBlock:** 400 error is shown when closing 21.15.282 video player ([c9a5530](https://github.com/iDNA420/morphe-patches/commit/c9a553048c318ec79ae893c06b0fe3aaf381528d))
* **YouTube - SponsorBlock:** Do not show context toast when auto skipping videos in the feed ([17d8bd0](https://github.com/iDNA420/morphe-patches/commit/17d8bd0b90d11193c7a9f3411f119ddf1aa058bd))
* **YouTube - SponsorBlock:** Resolve segments not fetching on experimental app targets ([46a5d9a](https://github.com/iDNA420/morphe-patches/commit/46a5d9a0de18231b5dd4e664d6992b36663386ee))
* **YouTube - SponsorBlock:** Show correct nested skip segment in overlay controls when seeking to an earlier video time ([1e13236](https://github.com/iDNA420/morphe-patches/commit/1e1323670c1265466532919424c52016cd661492))
* **YouTube - Spoof app version:** Change oldest spoof target to `19.35.36` ([#86](https://github.com/iDNA420/morphe-patches/issues/86)) ([4ff0959](https://github.com/iDNA420/morphe-patches/commit/4ff09591a89a3203aa3a1f27580126783ee9edf5))
* **YouTube - Spoof app version:** Resolve experimental patching of `21.05.264` ([3d7c0e6](https://github.com/iDNA420/morphe-patches/commit/3d7c0e6fc953775048c58a77004a4938e4df7ba8))
* **YouTube - Spoof video streams:** Age-restricted videos do not play in the `Android No SDK` client ([#3](https://github.com/iDNA420/morphe-patches/issues/3)) ([6ec9e30](https://github.com/iDNA420/morphe-patches/commit/6ec9e3033a84fe34cbd298dbeb740f09645003da))
* **YouTube - Spoof video streams:** Resolve Shorts freezing and feed scrolling issues ([#1433](https://github.com/iDNA420/morphe-patches/issues/1433)) ([85e0b0c](https://github.com/iDNA420/morphe-patches/commit/85e0b0c08f465e067716d52c66af396f28b267b0))
* **YouTube - Swipe controls:** 2x speed action is triggered when the status bar is visible on Android 15+ ([#1341](https://github.com/iDNA420/morphe-patches/issues/1341)) ([e0005d3](https://github.com/iDNA420/morphe-patches/commit/e0005d38ac9140a0a4209a28bdf9601ac9759034))
* **YouTube - Swipe controls:** Swipe controls sometimes do not work ([#905](https://github.com/iDNA420/morphe-patches/issues/905)) ([bd23813](https://github.com/iDNA420/morphe-patches/commit/bd23813b31ade167e4b1cff3b636163c41696c49))
* **YouTube - Theme:** Adjust black color overrides ([b779c12](https://github.com/iDNA420/morphe-patches/commit/b779c1245e241b2ad2929cc01767e86ea814cfc4))
* **YouTube - Theme:** Adjust theme color replacement ([12fc228](https://github.com/iDNA420/morphe-patches/commit/12fc2284bd719d9992045474f2b7e0cf20b976fd))
* **YouTube - Theme:** Apply dark color to 21.06+ experimental app targets ([#495](https://github.com/iDNA420/morphe-patches/issues/495)) ([62ca1be](https://github.com/iDNA420/morphe-patches/commit/62ca1bed0f3cc4713420b3299872ce2fb285c03e))
* **YouTube - Theme:** Apply light/dark theme colors to `21.17.480` ([290315f](https://github.com/iDNA420/morphe-patches/commit/290315f9847158f947adf045234e99292d7190cd))
* **YouTube - Theme:** Carbon background color does not use custom background color with experimental app targets ([fa2439d](https://github.com/iDNA420/morphe-patches/commit/fa2439d09286db83a0d588b407bbc5248e1589cf))
* **YouTube - Theme:** Override missing 21.06+ light theme color ([a338f0f](https://github.com/iDNA420/morphe-patches/commit/a338f0f5e5885cd04539ffd831930d1643303c26))
* **YouTube - Theme:** Resolve theme color incorrectly applying to player overlay ([bbf94ec](https://github.com/iDNA420/morphe-patches/commit/bbf94ec0b24a1684d8c565a5eec4bf4aefd6bf57))
* **YouTube - Theme:** Show correct icon light/dark mode if using YouTube light/dark manual override ([3f5d75a](https://github.com/iDNA420/morphe-patches/commit/3f5d75a39a7450262207bc26e43ef2c3862c9e47))
* **YouTube - Theme:** Use correct theme color for settings icon ([a6d472d](https://github.com/iDNA420/morphe-patches/commit/a6d472d35c19ad3aa3a6aa1b2544d61d4070b78e))
* **YouTube - Video quality:** Initial video quality is not overridden ([#822](https://github.com/iDNA420/morphe-patches/issues/822)) ([753026a](https://github.com/iDNA420/morphe-patches/commit/753026a6a11552be34b41d55f5d6c0bc728858c7))
* **YouTube Music - Change start page:** Hide Podcast option that shows an error message for users in unsupported countries ([b0a9fb6](https://github.com/iDNA420/morphe-patches/commit/b0a9fb68ba2909889612165f1f1df5bff8fecd21))
* **YouTube Music - Hide ads:** Home feed does not load when Hide fullscreen ads setting is enabled ([0208916](https://github.com/iDNA420/morphe-patches/commit/0208916e2774451c6fc72258005adc4221c84953))
* **YouTube Music - Hide buttons:** An exception is thrown due to an invalid fingerprint format ([dd796a0](https://github.com/iDNA420/morphe-patches/commit/dd796a0dae028719ce7f9bb8234e229b8e8f4d1e))
* **YouTube Music - Navigation bar:** Hide library tab with 8.24+ ([5e8c0f8](https://github.com/iDNA420/morphe-patches/commit/5e8c0f8b5d2e066633fc43a4b8c6716c8bb3b453))
* **YouTube Music - Permanent repeat:** Resolve patch failing on `7.29.52` ([#1231](https://github.com/iDNA420/morphe-patches/issues/1231)) ([a6bcf55](https://github.com/iDNA420/morphe-patches/commit/a6bcf558b265bc43b210fe7af29bb8dc55d5253a))
* **YouTube Music - Permanent repeat:** Resolve repeat state not being permanent ([#1193](https://github.com/iDNA420/morphe-patches/issues/1193)) ([ab5a914](https://github.com/iDNA420/morphe-patches/commit/ab5a914eb6968a0cdb3de9c2c0f45d1cd42cce4e))
* **YouTube Music - Track crossfade:** Crossfade does not work when screen is locked ([#1312](https://github.com/iDNA420/morphe-patches/issues/1312)) ([cc7b8f1](https://github.com/iDNA420/morphe-patches/commit/cc7b8f1b7b96bcbba099bf388bb7cd73db51db13))
* **YouTube Music - Track crossfade:** Stop playback when app is closed and improvements to auto-play crossfade transitions ([#1243](https://github.com/iDNA420/morphe-patches/issues/1243)) ([676d61b](https://github.com/iDNA420/morphe-patches/commit/676d61b5b81f2c63fe27570f38148d7d9297177e))
* **YouTube Music:** Change recommended version to `8.37.56` ([a72bf50](https://github.com/iDNA420/morphe-patches/commit/a72bf503e0d12010f2135d020af03f6a5f4204df))
* **YouTube:** "Restore old setings menu" does not work with experimental app targets ([#1127](https://github.com/iDNA420/morphe-patches/issues/1127)) ([74826e6](https://github.com/iDNA420/morphe-patches/commit/74826e6aea75dec8e7290f33e4bf9eb476d2abe8))
* **YouTube:** Add experimental support for `21.06.251` ([3872f34](https://github.com/iDNA420/morphe-patches/commit/3872f34adf76b7b20c554d3c9af4890ba06f38e6))
* **YouTube:** Add experimental support for `21.07.240` ([015d66a](https://github.com/iDNA420/morphe-patches/commit/015d66a3d9fb352f5be47af59139d736fe43b26b))
* **YouTube:** Advanced video quality menu does not work ([3381026](https://github.com/iDNA420/morphe-patches/commit/3381026a63c91460243cb512554e64d0f3662a70))
* **YouTube:** Background playback PiP shows a black bar after using livestream chat ([#1173](https://github.com/iDNA420/morphe-patches/issues/1173)) ([1a30f60](https://github.com/iDNA420/morphe-patches/commit/1a30f6022166a11cacbce7e098ed474039458829))
* **YouTube:** Bold player buttons break under certain conditions ([#1126](https://github.com/iDNA420/morphe-patches/issues/1126)) ([8d928f5](https://github.com/iDNA420/morphe-patches/commit/8d928f596323b4d33cd2ae071a6c47101a61404b))
* **YouTube:** Change "Hide mix playlist" to default off ([00f1240](https://github.com/iDNA420/morphe-patches/commit/00f124004efd758092a5a8330aaea92f08064172))
* **YouTube:** Changes the default values for some settings ([#10](https://github.com/iDNA420/morphe-patches/issues/10)) ([8fbcb9e](https://github.com/iDNA420/morphe-patches/commit/8fbcb9edcee228c5a9f74c11307a7c28532c48e1))
* **YouTube:** Consolidate toolbar "Hide cast button" into existing hide cast button setting ([c22a2a1](https://github.com/iDNA420/morphe-patches/commit/c22a2a1c7a74b6370bad7b47ce79cab9b49846ad))
* **YouTube:** Do not show bold icons if old settings menus is enabled ([05215fb](https://github.com/iDNA420/morphe-patches/commit/05215fbaa90885495dbc5a91cc0b6721c94633e8))
* **YouTube:** Do not show fullscreen black gradient with 21.03+ experimental app targets ([0202d57](https://github.com/iDNA420/morphe-patches/commit/0202d57a2cb0af94257f06163f0c8e219346ac95))
* **YouTube:** Fullscreen gradient does not show with bold player layout ([d019c01](https://github.com/iDNA420/morphe-patches/commit/d019c0172d0a3f205f457c9bde873a7fbfb54bd9))
* **YouTube:** Move loop video setting to player menu ([05d04fc](https://github.com/iDNA420/morphe-patches/commit/05d04fcc73fbbe6c58abf25336d06d7fcab99b9d))
* **YouTube:** prevent related video hiding with restricted video confirmation watching ([#1235](https://github.com/iDNA420/morphe-patches/issues/1235)) ([7005f13](https://github.com/iDNA420/morphe-patches/commit/7005f13aa385768bb9c5852ee395cb028fa21d79))
* **YouTube:** Prompt to restart app on first launch of clean install ([#874](https://github.com/iDNA420/morphe-patches/issues/874)) ([35634b7](https://github.com/iDNA420/morphe-patches/commit/35634b772b8a7a437d560dcd7e6bf667148957de))
* **YouTube:** Remove `19.43.41` that YouTube no longer supports ([9c511b6](https://github.com/iDNA420/morphe-patches/commit/9c511b6d1832724f987139ed5eec11ea4f9d0ee4))
* **YouTube:** Replace themed like animation applied from wrong version due to server-side fault ([#261](https://github.com/iDNA420/morphe-patches/issues/261)) ([556dbb6](https://github.com/iDNA420/morphe-patches/commit/556dbb68839d5c73dea20e23079d91b20f02d109))
* **YouTube:** Resolve 20.47.62 crashing ([d472802](https://github.com/iDNA420/morphe-patches/commit/d4728022e29c8babf811bf56f3b32174e81bdef7))
* **YouTube:** Resolve app crash when opening community post ([41a5e66](https://github.com/iDNA420/morphe-patches/commit/41a5e66b04afb51ff25d0b620e053c50605f1939))
* **YouTube:** Resolve experimental `21.05.264` Shorts crash ([eda285a](https://github.com/iDNA420/morphe-patches/commit/eda285a096024cc262eaf2233e6fbdc4ce77d275))
* **YouTube:** Resolve experimental `21.05.264` video description crash ([90a7fae](https://github.com/iDNA420/morphe-patches/commit/90a7faeb5adf0eb60cb519d7ae455102236e9e2d))
* **YouTube:** Resolve experimental patching of `21.06.257` ([62f68a4](https://github.com/iDNA420/morphe-patches/commit/62f68a47a690d027f16e0d05b963ea399f6237bb))
* **YouTube:** Show a more descriptive error message if attempting to patch a region specific APKM that does not contain languages for all regions ([0f2700d](https://github.com/iDNA420/morphe-patches/commit/0f2700db110a2e8d041e1213e0d95ed50f6d54ac))
* **YouTube:** Swiping back on home feed does not close the app ([74a5074](https://github.com/iDNA420/morphe-patches/commit/74a5074991ec935d0588843b1067a084944c2e42))
* **YouTube:** Use legacy layout parameters with older app targets ([329473a](https://github.com/iDNA420/morphe-patches/commit/329473aadec23209800ad54aa4daa5df5a24e8f3))
* **YT Music:** Support `8.49.52` ([7bdc05e](https://github.com/iDNA420/morphe-patches/commit/7bdc05eaaa25a6c92b052e7c0f36419753646e32))

### ✨ New Features

* Add `Disable DRC audio` patch ([#461](https://github.com/iDNA420/morphe-patches/issues/461)) ([e1bd7bd](https://github.com/iDNA420/morphe-patches/commit/e1bd7bda5bc6916c6142a9b1102d094411a5a89f))
* Add `Disable Play Store updates`, `Custom branding name for Reddit`, improve `Change package name` ([#575](https://github.com/iDNA420/morphe-patches/issues/575)) ([60a2f9e](https://github.com/iDNA420/morphe-patches/commit/60a2f9e5b27ca126c4cce3a7207c197675f10d80))
* Add `Disable QUIC protocol` patch ([#586](https://github.com/iDNA420/morphe-patches/issues/586)) ([41fac61](https://github.com/iDNA420/morphe-patches/commit/41fac61cfdfeb0e469f13eb8d4e54e7cb054f34d))
* Add dark icon ([#16](https://github.com/iDNA420/morphe-patches/issues/16)) ([9f1448e](https://github.com/iDNA420/morphe-patches/commit/9f1448e9e63cc8035bb43ea2233233f249356c4e))
* Add Import/Export settings from/to a file ([#865](https://github.com/iDNA420/morphe-patches/issues/865)) ([098a0d8](https://github.com/iDNA420/morphe-patches/commit/098a0d8e8993baff5e85676aae6ff5a66d615473))
* Add Kurmanji Crowdin translations ([2413a08](https://github.com/iDNA420/morphe-patches/commit/2413a083ddd6c6768e5db5bd7e814107c97cb8e1))
* Add less restrictive license for build related code ([ef0c1cc](https://github.com/iDNA420/morphe-patches/commit/ef0c1ccfea214c85250523dda04ec9c0834dd3a0))
* Add miscellaneous link handling preference to help change 'open with' links ([#1389](https://github.com/iDNA420/morphe-patches/issues/1389)) ([c364ced](https://github.com/iDNA420/morphe-patches/commit/c364ced39ccbe5a4183cb07c2e70d4a666b08c46))
* Add new About dialog style ([#21](https://github.com/iDNA420/morphe-patches/issues/21)) ([bb96947](https://github.com/iDNA420/morphe-patches/commit/bb96947011ffad36a7cd81c8e8d97927228a1f51))
* Add overlay buttons animation ([#20](https://github.com/iDNA420/morphe-patches/issues/20)) ([200d52f](https://github.com/iDNA420/morphe-patches/commit/200d52ffbaced715e577068050ae33bb26f2dfe6))
* Add search and file export to debug logs ([#997](https://github.com/iDNA420/morphe-patches/issues/997)) ([a53a6c3](https://github.com/iDNA420/morphe-patches/commit/a53a6c3b0c8f534e4bca4a015a25452d2c73ae8a))
* **Enable debugging:** Allow overriding String/long/double flags in debug flag manager ([11b61b5](https://github.com/iDNA420/morphe-patches/commit/11b61b5a509a4d659e69e9cfd9c3cdcad70dd9cb))
* Generate new release ([f7f9a61](https://github.com/iDNA420/morphe-patches/commit/f7f9a61698ba74dfea4927157ac6951b5bc717a0))
* **GmsCore support:** Add a setting to not prompt to disable MicroG battery optimization ([#921](https://github.com/iDNA420/morphe-patches/issues/921)) ([4632fb6](https://github.com/iDNA420/morphe-patches/commit/4632fb69f9359a709e96d4699d9bfb05133c3a5c))
* Per-theme notification and monochrome icons, add Play icon ([#978](https://github.com/iDNA420/morphe-patches/issues/978)) ([ddc59c9](https://github.com/iDNA420/morphe-patches/commit/ddc59c9a96d4b77ca72642e4919e27b9872beee0))
* Perform full search of free registers ([2980f64](https://github.com/iDNA420/morphe-patches/commit/2980f64c9ee58f19d21db3f14e2120d2ce1deb85))
* **Reddit:** Add "Disable modern home" and "Show view count", fix "Hide navigation buttons" ([#823](https://github.com/iDNA420/morphe-patches/issues/823)) ([d7c26f2](https://github.com/iDNA420/morphe-patches/commit/d7c26f257470b66d319bc8e156d9651552a7aac0))
* **Reddit:** Add `Hide Ask button` patch ([#1129](https://github.com/iDNA420/morphe-patches/issues/1129)) ([3ff35f9](https://github.com/iDNA420/morphe-patches/commit/3ff35f9a5288999d84b1c2323407dd533ed1db2d))
* **Reddit:** Add `Hide Reddit search` patch ([#1128](https://github.com/iDNA420/morphe-patches/issues/1128)) ([08a1f52](https://github.com/iDNA420/morphe-patches/commit/08a1f528199e6dede11c8f3cc94322f669a7fac1))
* **Reddit:** Add `Open links externally` patch ([#1131](https://github.com/iDNA420/morphe-patches/issues/1131)) ([78be254](https://github.com/iDNA420/morphe-patches/commit/78be254db96f39f93d9a2ac326c7907c2d836f6e))
* **Reddit:** Add ability to hide Games button on nav bar ([#315](https://github.com/iDNA420/morphe-patches/issues/315)) ([07b9fc2](https://github.com/iDNA420/morphe-patches/commit/07b9fc250b24c0219e8f650883f3c22ea7dfa23f))
* **Reddit:** Add Crowdin translations ([#882](https://github.com/iDNA420/morphe-patches/issues/882)) ([c08ccdb](https://github.com/iDNA420/morphe-patches/commit/c08ccdb30b460ccbe7ca70b2a5c427b05ba29a3c))
* **Reddit:** Add experimental support for `2026.10.0` ([#762](https://github.com/iDNA420/morphe-patches/issues/762)) ([7117724](https://github.com/iDNA420/morphe-patches/commit/711772404d3a4cee3ac51b6837d15de2e419de3b))
* **Reddit:** Add experimental support for `2026.11.0` ([e09ddcb](https://github.com/iDNA420/morphe-patches/commit/e09ddcb9d4082ccd13d3b131baf91d24cf003942))
* **Reddit:** Add experimental support for `2026.12.0` ([#999](https://github.com/iDNA420/morphe-patches/issues/999)) ([8df2a01](https://github.com/iDNA420/morphe-patches/commit/8df2a010ef2950c503dcb640b19207357da0d248))
* **Reddit:** Add experimental support for `2026.13.0` ([722f5bf](https://github.com/iDNA420/morphe-patches/commit/722f5bf34f986c51b9631575cd09eb64dac47314))
* **Reddit:** Add experimental support for `2026.14.0` ([921fa89](https://github.com/iDNA420/morphe-patches/commit/921fa89a37a4e318ed3ba5a0cb090b00f0a4c3af))
* **Reddit:** Add experimental support for `2026.15.0` ([784c83c](https://github.com/iDNA420/morphe-patches/commit/784c83c676c48525fb4c4575fbce00bcf0b6c024))
* **Reddit:** Add experimental support for `2026.15.1` ([2a6442e](https://github.com/iDNA420/morphe-patches/commit/2a6442ebbad12d858b30fb2f2594cb06c2e4a0d0))
* **Reddit:** Add experimental support for `2026.16.0` ([887c14d](https://github.com/iDNA420/morphe-patches/commit/887c14d1d96a7d564cabcd301a03c5e7d19222cf))
* **Reddit:** Add experimental support for `2026.17.0` ([c41d0f8](https://github.com/iDNA420/morphe-patches/commit/c41d0f8782781aadfcea25d96fbe37295074f014))
* **Reddit:** Add experimental support for `2026.18.0` ([019c338](https://github.com/iDNA420/morphe-patches/commit/019c338c9c4c82f0b5342c117553887a4c6defce))
* **Reddit:** Add experimental support for `2026.19.0` ([c4f6058](https://github.com/iDNA420/morphe-patches/commit/c4f6058872a007624aaafc1456f46733ec6e2212))
* **Reddit:** Add support for Reddit `2026.04.0` ([#276](https://github.com/iDNA420/morphe-patches/issues/276)) ([0203cf6](https://github.com/iDNA420/morphe-patches/commit/0203cf62d7214fe79b42a804fc51111e805f2afd))
* **Reddit:** Support version `2026.04.0` ([#545](https://github.com/iDNA420/morphe-patches/issues/545)) ([c59a0fc](https://github.com/iDNA420/morphe-patches/commit/c59a0fc966cbe3f94c5bf3886fd96eaa80049b98))
* **Reddit:** Support version `2026.10.0` ([ea135fb](https://github.com/iDNA420/morphe-patches/commit/ea135fb439b784c1b4336cc5245b64d8af5b2697))
* Set notification icon independently of the launcher icon ([#1006](https://github.com/iDNA420/morphe-patches/issues/1006)) ([f21c62d](https://github.com/iDNA420/morphe-patches/commit/f21c62de9e2897c5096d1545a40cfe21c6c25f44))
* Show a list of patches in the GitHub readme ([#1304](https://github.com/iDNA420/morphe-patches/issues/1304)) ([73beef5](https://github.com/iDNA420/morphe-patches/commit/73beef5ddf1b535161e2a3cd7e6799d129b761af))
* Show an experimental user on the first launch of an experimental app target ([#414](https://github.com/iDNA420/morphe-patches/issues/414)) ([d52b9c9](https://github.com/iDNA420/morphe-patches/commit/d52b9c97bc581a67708a0c9efe01472b24e0df5d))
* Simplify settings summary text ([#1366](https://github.com/iDNA420/morphe-patches/issues/1366)) ([67576a8](https://github.com/iDNA420/morphe-patches/commit/67576a8ffd2c81326acc178454148bbca315a855))
* Skip publishing to GitHub packages ([#275](https://github.com/iDNA420/morphe-patches/issues/275)) ([71b7db4](https://github.com/iDNA420/morphe-patches/commit/71b7db4d38ac44ce6d0b9de111599485e1de015a))
* **Spoof video streams:** Add "Force player JavaScript hash" and "Player JavaScript hash" ([#722](https://github.com/iDNA420/morphe-patches/issues/722)) ([c184dbe](https://github.com/iDNA420/morphe-patches/commit/c184dbe74aac4f2c2f7cb74955a05063209a9f2e))
* **Spoof video streams:** Add `Android Reel` client ([#580](https://github.com/iDNA420/morphe-patches/issues/580)) ([01bbde3](https://github.com/iDNA420/morphe-patches/commit/01bbde3dfea162eedf9af36dddffaba5d750db73))
* **Spoof video streams:** Add an option to sign-in to Android VR ([#23](https://github.com/iDNA420/morphe-patches/issues/23)) ([01e9073](https://github.com/iDNA420/morphe-patches/commit/01e90736f1b0a4a36a5aaecbe183b2f2349c6f50))
* **Spoof video streams:** Default client maintenance ([#11](https://github.com/iDNA420/morphe-patches/issues/11)) ([8ca1adb](https://github.com/iDNA420/morphe-patches/commit/8ca1adbd29c6f4d268b42452026f440b2ec7dc46))
* **Spoof video streams:** Default client maintenance ([#249](https://github.com/iDNA420/morphe-patches/issues/249)) ([ea01bfc](https://github.com/iDNA420/morphe-patches/commit/ea01bfca9afdf0592f0486795047ef5b0abcb5ff))
* **Spoof video streams:** Default client maintenance ([#340](https://github.com/iDNA420/morphe-patches/issues/340)) ([d72cfbe](https://github.com/iDNA420/morphe-patches/commit/d72cfbe5ccad91ca4527a23da9aa8a55bfb161f1))
* **Spoof video streams:** Default client maintenance ([#448](https://github.com/iDNA420/morphe-patches/issues/448)) ([36817a3](https://github.com/iDNA420/morphe-patches/commit/36817a35c0f337f7d988624d8aebac418424a5f2))
* **Spoof video streams:** Default client maintenance ([#789](https://github.com/iDNA420/morphe-patches/issues/789)) ([142367e](https://github.com/iDNA420/morphe-patches/commit/142367e1c0ee3f03341fa5c3c0483aed7384c208))
* **Spoof video streams:** Default client maintenance ([#928](https://github.com/iDNA420/morphe-patches/issues/928)) ([0884870](https://github.com/iDNA420/morphe-patches/commit/088487090bc59b1c6358551f4e4634f2a847e781))
* **Spoof video streams:** Minor improvements reflecting code review ([#730](https://github.com/iDNA420/morphe-patches/issues/730)) ([cbfe030](https://github.com/iDNA420/morphe-patches/commit/cbfe03035683ee6b7c205327eabcd3e515c35ec8))
* **Spoof video streams:** Update yt-dlp-ejs ([#871](https://github.com/iDNA420/morphe-patches/issues/871)) ([0fd599a](https://github.com/iDNA420/morphe-patches/commit/0fd599a08145c9a78d0882342095a26f6a230102))
* **Theme:** Use dynamic system accents for Material You colors ([#693](https://github.com/iDNA420/morphe-patches/issues/693)) ([1a2e61c](https://github.com/iDNA420/morphe-patches/commit/1a2e61ce2e64f82adc51f215ed79b8c02cf6b869))
* Use Morphe patcher 1.1.1 ([#347](https://github.com/iDNA420/morphe-patches/issues/347)) ([f0178c3](https://github.com/iDNA420/morphe-patches/commit/f0178c3048a001f7aa4ffae4cccbdb756b64553c))
* Use shared morphe-patches-library for common code ([#1068](https://github.com/iDNA420/morphe-patches/issues/1068)) ([a0c5c06](https://github.com/iDNA420/morphe-patches/commit/a0c5c060bd34159ebe3d13a172e61aa37860a887))
* **YouTube - Auto-captions:** Add an option to disable auto-captions when the device volume is muted ([#37](https://github.com/iDNA420/morphe-patches/issues/37)) ([b29da4d](https://github.com/iDNA420/morphe-patches/commit/b29da4df3d12789465e2def378b00ab6d4e0ef6d))
* **YouTube - Captions:** Add "Set caption cookies" and "Fix transcript" settings ([#341](https://github.com/iDNA420/morphe-patches/issues/341)) ([0e50fc7](https://github.com/iDNA420/morphe-patches/commit/0e50fc7de9b667f6f9b1e61cec2cfd2f6011e126))
* **YouTube - Disable haptic feedback:** Add `Disable tap and hold haptics` setting ([#592](https://github.com/iDNA420/morphe-patches/issues/592)) ([279722a](https://github.com/iDNA420/morphe-patches/commit/279722a153573cc4d93bbe8becef31aa930cf0aa))
* **YouTube - Downloads:** Add "Seal Plus" as a hidden preset downloader ([#357](https://github.com/iDNA420/morphe-patches/issues/357)) ([077128c](https://github.com/iDNA420/morphe-patches/commit/077128c9115ae0f168c9710fc2d1bb8f1a5ee236))
* **YouTube - Hide ads:** Add `Hide player popup ads` setting ([#583](https://github.com/iDNA420/morphe-patches/issues/583)) ([82c9f29](https://github.com/iDNA420/morphe-patches/commit/82c9f29f0903416bade9613a6672822003968893))
* **YouTube - Hide layout components:** Add "Comments carousel filter" setting ([#909](https://github.com/iDNA420/morphe-patches/issues/909)) ([4239720](https://github.com/iDNA420/morphe-patches/commit/42397200183b8c4b5edd6bd3d27cd8f2b6706756))
* **YouTube - Hide layout components:** Add "Hide Auto-dubbed label", "Hide Corrections section", "Hide Hyped label",  and "Hide Video details section" settings ([#1367](https://github.com/iDNA420/morphe-patches/issues/1367)) ([43b79c6](https://github.com/iDNA420/morphe-patches/commit/43b79c6b4679eb7bd5d9983aa4d4e3f8d2ffbb21))
* **YouTube - Hide layout components:** Add "Hide channel tab filter" setting ([#540](https://github.com/iDNA420/morphe-patches/issues/540)) ([5cca175](https://github.com/iDNA420/morphe-patches/commit/5cca175398ade42675b3c5e082d8fbe7b1043ab1))
* **YouTube - Hide layout components:** Add "Hide collapse button" and "Hide fullscreen button" settings ([#511](https://github.com/iDNA420/morphe-patches/issues/511)) ([91f1aad](https://github.com/iDNA420/morphe-patches/commit/91f1aadb386ccfd58cfaf0cf44601af48225f40c))
* **YouTube - Hide layout components:** Add "Hide comment prompts" setting ([#463](https://github.com/iDNA420/morphe-patches/issues/463)) ([3ca9551](https://github.com/iDNA420/morphe-patches/commit/3ca95517f45acbc34a25c569e975e903e6eafa1f))
* **YouTube - Hide layout components:** Add "Hide comments section in Home feed" setting ([#382](https://github.com/iDNA420/morphe-patches/issues/382)) ([b20f629](https://github.com/iDNA420/morphe-patches/commit/b20f6294236cad32b1be29b73e761659193e464b))
* **YouTube - Hide layout components:** Add "Hide course progress" setting ([#351](https://github.com/iDNA420/morphe-patches/issues/351)) ([4a83b54](https://github.com/iDNA420/morphe-patches/commit/4a83b54c292a66f5ca2825c0f4a45a5650c528d4))
* **YouTube - Hide layout components:** Add "Hide explore this course" setting ([#410](https://github.com/iDNA420/morphe-patches/issues/410)) ([42eaca0](https://github.com/iDNA420/morphe-patches/commit/42eaca0d04c51ff5ae30b418ed8d2b9dd771ccc5))
* **YouTube - Hide layout components:** Add "Hide Featured links", "Hide Featured videos", "Hide Join button", and "Hide Subscribe button" options ([#72](https://github.com/iDNA420/morphe-patches/issues/72)) ([9788196](https://github.com/iDNA420/morphe-patches/commit/9788196c462baa342b4ad71e596dd7c21077fd44))
* **YouTube - Hide layout components:** Add "Hide feed flyout menu filter" setting ([#535](https://github.com/iDNA420/morphe-patches/issues/535)) ([06c8215](https://github.com/iDNA420/morphe-patches/commit/06c8215d4320b38ad5f168eabcb5fc29a6ce4640))
* **YouTube - Hide layout components:** Add "Hide Info button" setting ([#944](https://github.com/iDNA420/morphe-patches/issues/944)) ([d43fbeb](https://github.com/iDNA420/morphe-patches/commit/d43fbeb9b790eba32f62656a95a613c06d8ef021))
* **YouTube - Hide layout components:** Add "Hide Latest videos button" setting ([#305](https://github.com/iDNA420/morphe-patches/issues/305)) ([aed3e34](https://github.com/iDNA420/morphe-patches/commit/aed3e343885732bb86647ddf626efdc173ca2ed6))
* **YouTube - Hide layout components:** Add "Hide live chat donators bar" setting ([#1236](https://github.com/iDNA420/morphe-patches/issues/1236)) ([d058745](https://github.com/iDNA420/morphe-patches/commit/d0587451c26e80cead531a19843852bdca641c53))
* **YouTube - Hide layout components:** Add "Hide live chat replay button" setting ([#330](https://github.com/iDNA420/morphe-patches/issues/330)) ([7a6c697](https://github.com/iDNA420/morphe-patches/commit/7a6c69791cafc9247a55ac4c6ad30dcabba96d70))
* **YouTube - Hide layout components:** Add "Hide Quizzes" setting ([#425](https://github.com/iDNA420/morphe-patches/issues/425)) ([c843c32](https://github.com/iDNA420/morphe-patches/commit/c843c32e69c078a6b8da2d1c3045f0b31898c53e))
* **YouTube - Hide layout components:** Add "Hide search term thumbnails" setting ([#1116](https://github.com/iDNA420/morphe-patches/issues/1116)) ([61d5fd6](https://github.com/iDNA420/morphe-patches/commit/61d5fd62f300640240a82f477bb56c82cbedfbee))
* **YouTube - Hide layout components:** Add "Hide Settings button" setting for player ([#1187](https://github.com/iDNA420/morphe-patches/issues/1187)) ([c665a5c](https://github.com/iDNA420/morphe-patches/commit/c665a5ce8e39ff2e7ac10286372918ce47c35c21))
* **YouTube - Hide layout components:** Add "Hide subscribed channels bar" setting ([#226](https://github.com/iDNA420/morphe-patches/issues/226)) ([bbaad3a](https://github.com/iDNA420/morphe-patches/commit/bbaad3af85b43a7addc0e984a5a13e12986f6263))
* **YouTube - Hide layout components:** Add "Hide video title" setting ([#309](https://github.com/iDNA420/morphe-patches/issues/309)) ([2c7a973](https://github.com/iDNA420/morphe-patches/commit/2c7a973d73644d81da1dd4a82a3b10056863ac70))
* **YouTube - Hide layout components:** Add list preference for hiding expandable cards ([#1123](https://github.com/iDNA420/morphe-patches/issues/1123)) ([7f96bcd](https://github.com/iDNA420/morphe-patches/commit/7f96bcd6fd4cea0c69e3aa683393e9db4ef7aab5))
* **YouTube - Hide player flyout menu components:** Add "Hide Audio track footer", "Hide Captions footer", and "Hide Captions header" settings ([#642](https://github.com/iDNA420/morphe-patches/issues/642)) ([19c6c2d](https://github.com/iDNA420/morphe-patches/commit/19c6c2d525c6dab715f21210d690ea68f7b22f7a))
* **YouTube - Hide Shorts components:** Add "Disable double-tap to like" setting ([#1275](https://github.com/iDNA420/morphe-patches/issues/1275)) ([73c2c58](https://github.com/iDNA420/morphe-patches/commit/73c2c58f27f62e1221215ce54e39fe9859feeaf5))
* **YouTube - Hide Shorts components:** Add "Hide 'Auto-dubbed' label" and "Hide live preview" options ([#70](https://github.com/iDNA420/morphe-patches/issues/70)) ([2d4ec91](https://github.com/iDNA420/morphe-patches/commit/2d4ec91e038cdbd65716127424afbd79a8dbe29a))
* **YouTube - Hide Shorts components:** Add "Hide AI button" setting ([#436](https://github.com/iDNA420/morphe-patches/issues/436)) ([eea4657](https://github.com/iDNA420/morphe-patches/commit/eea4657c94887d4e5f1e59a0392ee1f477bcd72b))
* **YouTube - Hide Shorts components:** Add "Hide in video description" setting ([#426](https://github.com/iDNA420/morphe-patches/issues/426)) ([7c01227](https://github.com/iDNA420/morphe-patches/commit/7c01227b49f3feb4382e895fe768cd1cc3e6afd4))
* **YouTube - Hide video action buttons:** Add "Hide quick actions" settings ([#1118](https://github.com/iDNA420/morphe-patches/issues/1118)) ([590033f](https://github.com/iDNA420/morphe-patches/commit/590033f9db845a5807e4456b03c7c5bad655e5b8))
* **YouTube - LithoFilterPatch:** Add support for accessibility filtering ([#1](https://github.com/iDNA420/morphe-patches/issues/1)) ([017eac7](https://github.com/iDNA420/morphe-patches/commit/017eac71a3f9542b8ad6221e3600797d6b97fae4))
* **YouTube - Miniplayer:** Add "Disable resuming miniplayer" setting ([#1342](https://github.com/iDNA420/morphe-patches/issues/1342)) ([0eb81a9](https://github.com/iDNA420/morphe-patches/commit/0eb81a91c2d70d4416a56fc91f3d238e4c6f2f29))
* **YouTube - Navigation bar:** Add "Disable auto-hide navigation bar" setting ([#973](https://github.com/iDNA420/morphe-patches/issues/973)) ([f04d001](https://github.com/iDNA420/morphe-patches/commit/f04d00108539368894aca6820e160324ab102559))
* **YouTube - Navigation bar:** Add "Hide Cast button" setting ([#1268](https://github.com/iDNA420/morphe-patches/issues/1268)) ([53dd12c](https://github.com/iDNA420/morphe-patches/commit/53dd12c0b25587f6cf5ea5c54f2a7b3924b03d75))
* **YouTube - Navigation bar:** Add "Hide navigation bar", "Replace Create with Settings", and "Show Settings" settings ([#688](https://github.com/iDNA420/morphe-patches/issues/688)) ([1b87895](https://github.com/iDNA420/morphe-patches/commit/1b8789530e9ca50f439653cb4c55ae1a031d980b))
* **YouTube - Navigation bar:** Add "Hide voice search button" setting ([#513](https://github.com/iDNA420/morphe-patches/issues/513)) ([b59ec4b](https://github.com/iDNA420/morphe-patches/commit/b59ec4b9e67c00e6fa284b50de294c805c255399))
* **YouTube - Navigation bar:** Add "Show Settings" in Toolbar and "Settings button action" in Navigation buttons ([#750](https://github.com/iDNA420/morphe-patches/issues/750)) ([7bd589e](https://github.com/iDNA420/morphe-patches/commit/7bd589eaf4abd1a69989be336b2f6e5521581bd5))
* **YouTube - Navigation bar:** Add `Show search button` setting ([#634](https://github.com/iDNA420/morphe-patches/issues/634)) ([b46e492](https://github.com/iDNA420/morphe-patches/commit/b46e4923592ce5f752d6e2db156a3838c25f4f4f))
* **YouTube - Navigation bar:** Add settings to hide toolbar buttons ([#298](https://github.com/iDNA420/morphe-patches/issues/298)) ([73fd722](https://github.com/iDNA420/morphe-patches/commit/73fd722c0d76148323ae60ddc64ae05c8d95b5d4))
* **YouTube - Navigation buttons:** Add setting to use narrow navigation bar buttons ([1074c6a](https://github.com/iDNA420/morphe-patches/commit/1074c6a6f70199ef8173524246be23bddcbb46d2))
* **YouTube - Playback speed:** Allows disabling tap and hold speed ([#819](https://github.com/iDNA420/morphe-patches/issues/819)) ([948a8a1](https://github.com/iDNA420/morphe-patches/commit/948a8a1c4d29b2d8855225706cb7db9c060d7a18))
* **YouTube - Sanitize sharing links:** Add setting to change Share links to shortened URLs ([#1346](https://github.com/iDNA420/morphe-patches/issues/1346)) ([f24c119](https://github.com/iDNA420/morphe-patches/commit/f24c1190796904e77a77a79e086208e6c059b09b))
* **YouTube - Seekbar:** Add "Enable livestream DVR" setting ([#1092](https://github.com/iDNA420/morphe-patches/issues/1092)) ([8af85d0](https://github.com/iDNA420/morphe-patches/commit/8af85d07b68e08f8e2731a77a4a08a1931348911))
* **YouTube - Seekbar:** Add "Expand livestream DVR duration" setting ([#1110](https://github.com/iDNA420/morphe-patches/issues/1110)) ([1a446d0](https://github.com/iDNA420/morphe-patches/commit/1a446d089c969993813a5017150ac8e648e26786))
* **YouTube - Sponsorblock:** Add highlight segment submission ([#1301](https://github.com/iDNA420/morphe-patches/issues/1301)) ([000846f](https://github.com/iDNA420/morphe-patches/commit/000846feb0c8fafd3c67f9d2c8c759c941c13b4d))
* **YouTube - SponsorBlock:** Show skip button if player overlay controls are active ([#243](https://github.com/iDNA420/morphe-patches/issues/243)) ([9f90d0e](https://github.com/iDNA420/morphe-patches/commit/9f90d0e386d8518ebd027a469ad72b52808048ab))
* **YouTube - Spoof app version:** Add target version `20.28.41` ([#375](https://github.com/iDNA420/morphe-patches/issues/375)) ([3793689](https://github.com/iDNA420/morphe-patches/commit/3793689be432ee1643e27670e2c845d4462a80b3))
* **YouTube - Spoof app version:** Add target version `20.39.41` ([9ef0d22](https://github.com/iDNA420/morphe-patches/commit/9ef0d2211aab5d5cb2d274678b2707ae0296499e))
* **YouTube - Spoof app version:** Remove target version `19.35.36` ([#458](https://github.com/iDNA420/morphe-patches/issues/458)) ([8c87a2c](https://github.com/iDNA420/morphe-patches/commit/8c87a2ccb529fa7b69dc98eaa6fcd4741e05508b))
* **YouTube - System media controls:** Add options to hide prev/next and seekbar in notification media controls ([#1322](https://github.com/iDNA420/morphe-patches/issues/1322)) ([71aa218](https://github.com/iDNA420/morphe-patches/commit/71aa218979117e5cc56d4656a578860845278b38))
* **YouTube - Theme:** Add "Hide splash screen" setting ([#245](https://github.com/iDNA420/morphe-patches/issues/245)) ([d8ae327](https://github.com/iDNA420/morphe-patches/commit/d8ae327bc74b23237ef877f352828c6c7c97ea53))
* **YouTube - Video quality:** Add "Prioritize video quality" setting ([#449](https://github.com/iDNA420/morphe-patches/issues/449)) ([9819078](https://github.com/iDNA420/morphe-patches/commit/98190781e890e56eeb0771496af43ce710e8443d))
* **YouTube - Video quality:** Add `Hide Premium video quality` setting ([#423](https://github.com/iDNA420/morphe-patches/issues/423)) ([fb3cb36](https://github.com/iDNA420/morphe-patches/commit/fb3cb368ea0bb9a05cefacf0509a35acbded5ae5))
* **YouTube Music - Hide ads:** Add "Hide fullscreen ads" setting ([#1192](https://github.com/iDNA420/morphe-patches/issues/1192)) ([b1d704d](https://github.com/iDNA420/morphe-patches/commit/b1d704d3be325c257abd4acce96516ec9038bd03))
* **YouTube Music:** Add `Change header` patch ([#650](https://github.com/iDNA420/morphe-patches/issues/650)) ([f6f03e5](https://github.com/iDNA420/morphe-patches/commit/f6f03e55d01863f3d436e00108cc608d933ddbd9))
* **YouTube Music:** Add `Change start page` patch ([#653](https://github.com/iDNA420/morphe-patches/issues/653)) ([bc3c1bd](https://github.com/iDNA420/morphe-patches/commit/bc3c1bda7afd3748f3bd7c7a9831ae4bad64b80f))
* **YouTube Music:** Add `Enable forced miniplayer` patch ([#720](https://github.com/iDNA420/morphe-patches/issues/720)) ([9c6f5f5](https://github.com/iDNA420/morphe-patches/commit/9c6f5f542d47222a8d7e1873b3742647455d6bf9))
* **YouTube Music:** Add `Miniplayer previous and next buttons` patch ([#818](https://github.com/iDNA420/morphe-patches/issues/818)) ([7e7e08d](https://github.com/iDNA420/morphe-patches/commit/7e7e08dbfff859890b3bce26fcc882cff1074f4a))
* **YouTube Music:** Add `Track crossfade` patch ([#1065](https://github.com/iDNA420/morphe-patches/issues/1065)) ([697c794](https://github.com/iDNA420/morphe-patches/commit/697c79412dd74ffd09dfedbc8458ba7ce3e2938b))
* **YouTube Music:** Add experimental support for `9.02.50` ([977cb8b](https://github.com/iDNA420/morphe-patches/commit/977cb8bfcdfb193b035b62ae2660d20eccdc6702))
* **YouTube Music:** Add experimental support for `9.03.52` ([80c0198](https://github.com/iDNA420/morphe-patches/commit/80c019889f51a1cf44a1e4f73da008a6b513ed90))
* **YouTube Music:** Add experimental support for `9.09.52` ([e42d9c1](https://github.com/iDNA420/morphe-patches/commit/e42d9c1bbdd6985378be47c8f9138ccdb22ead1e))
* **YouTube Music:** Add experimental support for `9.11.54` ([73eb7f1](https://github.com/iDNA420/morphe-patches/commit/73eb7f1475161517a965c0d9ebbb0f8e67a7af93))
* **YouTube Music:** Add experimental support for `9.12.51` ([746bdb9](https://github.com/iDNA420/morphe-patches/commit/746bdb9649ebbb252ac222110a3ca09eda227458))
* **YouTube Music:** Add experimental support for `9.13.50` ([bd462e5](https://github.com/iDNA420/morphe-patches/commit/bd462e5ab274968878314295b7238ae9371564d0))
* **YouTube Music:** Add experimental support for `9.14.51` ([e8c941f](https://github.com/iDNA420/morphe-patches/commit/e8c941ff053e20e54e6303ed405ca5421a4e5768))
* **YouTube Music:** Add experimental support for `9.15.50` ([2399828](https://github.com/iDNA420/morphe-patches/commit/239982892abbffd6e8e25d310692fb2e860b2c24))
* **YouTube Music:** Add experimental support for `9.16.51` ([e743ba8](https://github.com/iDNA420/morphe-patches/commit/e743ba870674f7826f81987c0d18393c97b35d1a))
* **YouTube Music:** Add experimental support for `9.17.51` ([d4cd2a6](https://github.com/iDNA420/morphe-patches/commit/d4cd2a628219e9dc57cb15452178514ee8aaebea))
* **YouTube Music:** Add experimental support for `9.18.50` ([5a9ca78](https://github.com/iDNA420/morphe-patches/commit/5a9ca78ed1354ec415592c63d532bf8d09fb3032))
* **YouTube Music:** Add experimental support for `9.19.50` ([a2c0681](https://github.com/iDNA420/morphe-patches/commit/a2c06815d0c3345bfc29aac0f7d555ac03f1f543))
* **YouTube Music:** Add support for `8.44.54` ([113e0b3](https://github.com/iDNA420/morphe-patches/commit/113e0b3f67a5470e000c0e15d91d0c44ab18b66d))
* **YouTube Music:** Add support for `8.47.56` ([fc5bcdd](https://github.com/iDNA420/morphe-patches/commit/fc5bcdd988f48e00c3ab031f41890ec2792a3a2e))
* **YouTube Music:** Support version `8.40.54` ([639819d](https://github.com/iDNA420/morphe-patches/commit/639819de0bec5f06fee4ff11c33f149521117d2b))
* **YouTube Music:** Unofficial support of `8.50.51` ([a284121](https://github.com/iDNA420/morphe-patches/commit/a2841213fe078fcfffc677c4e714489cb6a4622e))
* **YouTube:** Add "Hide search box trending results" setting ([#40](https://github.com/iDNA420/morphe-patches/issues/40)) ([dc1a898](https://github.com/iDNA420/morphe-patches/commit/dc1a898924f1cf4eaa94a29e967d7e966ae7a243))
* **YouTube:** Add `Ambient mode` patch ([#367](https://github.com/iDNA420/morphe-patches/issues/367)) ([91a68f5](https://github.com/iDNA420/morphe-patches/commit/91a68f5200d1f4061821aaba9f955a0fc9ec2cf1))
* **YouTube:** Add `Disable layout updates` patch ([#493](https://github.com/iDNA420/morphe-patches/issues/493)) ([0399388](https://github.com/iDNA420/morphe-patches/commit/039938837397317471e676e9608e4fcbc25f46ec))
* **YouTube:** Add `Double tap to seek` patch ([1a57a34](https://github.com/iDNA420/morphe-patches/commit/1a57a34734d31b803820b0a530e0c57c50963f63))
* **YouTube:** Add `Hide autoplay preview` patch ([#218](https://github.com/iDNA420/morphe-patches/issues/218)) ([4d105bd](https://github.com/iDNA420/morphe-patches/commit/4d105bd3d1a54ad0c59520156b0d88c68ea007ae)), closes [/github.com/inotia00/revanced-patches/blob/revanced-extended/patches/src/main/kotlin/app/revanced/patches/youtube/player/fullscreen/FullscreenComponentsPatch.kt#L155-L170](https://github.com/iDNA420//github.com/inotia00/revanced-patches/blob/revanced-extended/patches/src/main/kotlin/app/revanced/patches/youtube/player/fullscreen/FullscreenComponentsPatch.kt/issues/L155-L170)
* **YouTube:** Add `Hide releated videos` patch ([#685](https://github.com/iDNA420/morphe-patches/issues/685)) ([7a960e1](https://github.com/iDNA420/morphe-patches/commit/7a960e1a9f52ee2dcaea84298a62e9e2867100b7))
* **YouTube:** Add `Open channel of live avatar` patch ([#1408](https://github.com/iDNA420/morphe-patches/issues/1408)) ([b221097](https://github.com/iDNA420/morphe-patches/commit/b221097be8f1422f35f69b10d94775a2e245b01b))
* **YouTube:** Add `Open system share sheet` patch ([#625](https://github.com/iDNA420/morphe-patches/issues/625)) ([64ff907](https://github.com/iDNA420/morphe-patches/commit/64ff9079777a2b935886c35eae0e454984d56b52))
* **YouTube:** Add `Override YouTube Music actions` patch ([#677](https://github.com/iDNA420/morphe-patches/issues/677)) ([904dcda](https://github.com/iDNA420/morphe-patches/commit/904dcda3f17faf26753529351d5c4b57cdbda162))
* **YouTube:** Add `Play all` patch ([#1012](https://github.com/iDNA420/morphe-patches/issues/1012)) ([b3ac238](https://github.com/iDNA420/morphe-patches/commit/b3ac238aa15342706d60532ea0bba12f45fef2ac))
* **YouTube:** Add `Reload video` patch ([#873](https://github.com/iDNA420/morphe-patches/issues/873)) ([fad0e95](https://github.com/iDNA420/morphe-patches/commit/fad0e95e6be8b29bd32bcec4ef518efff3bcc0eb))
* **YouTube:** Add `Restore old search filters` patch ([#285](https://github.com/iDNA420/morphe-patches/issues/285)) ([c088723](https://github.com/iDNA420/morphe-patches/commit/c0887234612bb24ad8184fe211af14cf0640d8ec))
* **YouTube:** Add `Save to watch later` patch ([#1274](https://github.com/iDNA420/morphe-patches/issues/1274)) ([45cea2c](https://github.com/iDNA420/morphe-patches/commit/45cea2c860f7447d643c3c0af59d4517989c9306))
* **YouTube:** Add experimental support for `21.02.32` ([#138](https://github.com/iDNA420/morphe-patches/issues/138)) ([660699d](https://github.com/iDNA420/morphe-patches/commit/660699da7ee6b623d5010b42fe575e63947b450a))
* **YouTube:** Add experimental support for `21.03.34` ([#233](https://github.com/iDNA420/morphe-patches/issues/233)) ([4b9d7a6](https://github.com/iDNA420/morphe-patches/commit/4b9d7a6c8769e87e80727aa64dbc7d761513a259))
* **YouTube:** Add experimental support for `21.04.221` ([ba2e581](https://github.com/iDNA420/morphe-patches/commit/ba2e581bfbe1ebe9fb10fa49b33df43726c966f2))
* **YouTube:** Add experimental support for `21.05.264` ([#335](https://github.com/iDNA420/morphe-patches/issues/335)) ([a3f1a5c](https://github.com/iDNA420/morphe-patches/commit/a3f1a5c1a6fc21d2d6b1e30a600c0d5eaf0c2bf5))
* **YouTube:** Add experimental support for `21.08.261` ([#582](https://github.com/iDNA420/morphe-patches/issues/582)) ([87d3ac9](https://github.com/iDNA420/morphe-patches/commit/87d3ac955fc1f0a777b785e4294401d6451de330))
* **YouTube:** Add experimental support for `21.11.480` ([d8ced89](https://github.com/iDNA420/morphe-patches/commit/d8ced89845969bc09275ae540af82229f67799b3))
* **YouTube:** Add experimental support for `21.12.521` ([#925](https://github.com/iDNA420/morphe-patches/issues/925)) ([039e982](https://github.com/iDNA420/morphe-patches/commit/039e9827fe22562e6b4b9c103621a04f08509fc4))
* **YouTube:** Add experimental support for `21.13.163` ([ef345ba](https://github.com/iDNA420/morphe-patches/commit/ef345ba5579a3631420ca5f29d2e415ae7f19948))
* **YouTube:** Add experimental support for `21.14.482` ([bb6f79f](https://github.com/iDNA420/morphe-patches/commit/bb6f79f5a0ad36383a047586895d1c40212dae48))
* **YouTube:** Add experimental support for `21.15.282` ([647911e](https://github.com/iDNA420/morphe-patches/commit/647911ea660de94d771e4f9e97826ad4d28ffb89))
* **YouTube:** Add experimental support for `21.16.240` ([5a0992c](https://github.com/iDNA420/morphe-patches/commit/5a0992c98a5e560193706a200eebf51a49f9cb06))
* **YouTube:** Add experimental support for `21.17.480` ([1bb6403](https://github.com/iDNA420/morphe-patches/commit/1bb64036c33ce225d0f172d1e865e68b3f25ae72))
* **YouTube:** Add experimental support for `21.18.163` ([1bc264a](https://github.com/iDNA420/morphe-patches/commit/1bc264af775087244c2fa50f66b76999cad48fa0))
* **YouTube:** Add experimental support for `21.19.280` ([d1c7ac7](https://github.com/iDNA420/morphe-patches/commit/d1c7ac7b1580ddcc5a2e47211cfb572106b5ffce))
* **YouTube:** Add experimental support for `21.20.400` ([a4d1412](https://github.com/iDNA420/morphe-patches/commit/a4d1412849e578189adb04130f8559905cfe8f8f))
* **YouTube:** Add experimental support for `21.20.493` ([c09049d](https://github.com/iDNA420/morphe-patches/commit/c09049d46b94b5fa0097f3a53398469356b440f1))
* **YouTube:** Add Morphe bold style player buttons ([#954](https://github.com/iDNA420/morphe-patches/issues/954)) ([7f70b6f](https://github.com/iDNA420/morphe-patches/commit/7f70b6f10ab5e600f4297d4208641a0ea2d817b1))
* **YouTube:** Add support for `20.44.38` ([b022292](https://github.com/iDNA420/morphe-patches/commit/b022292192de08a913429400a44003fdc2622c3c))
* **YouTube:** Add support for `20.45.36` ([c22a6df](https://github.com/iDNA420/morphe-patches/commit/c22a6dfd07a9e1e980e5f5eb9ad22565b1da7f42))
* **YouTube:** Add support for `20.47.62` ([b143f54](https://github.com/iDNA420/morphe-patches/commit/b143f54c63f94651b6cd14ae1969746047f2ad60))
* **YouTube:** Support version `20.40.45` ([9514870](https://github.com/iDNA420/morphe-patches/commit/9514870fba460f21627ebfd6f849510c01321d91))

### 🔧 Improvements

* **Litho filtering:** Use Boyer-Moore-Horspool algorithm instead of KMP ([#960](https://github.com/iDNA420/morphe-patches/issues/960)) ([5b65548](https://github.com/iDNA420/morphe-patches/commit/5b655488bea90372ccf0e103cdb3229b51b8bfbd))
* Reduce patches bundle size ([#891](https://github.com/iDNA420/morphe-patches/issues/891)) ([74c4611](https://github.com/iDNA420/morphe-patches/commit/74c461185ac19a3d7258f738e92f49da74721703))
